  ...
  articles: [
    {
      ...
      text: '* Изучайте проекты реальных деревянных домов, бань и прочих построек и конструкций.\n* Используйте фильтры для поиска по заданным параметрам.\n* Получайте основные объемы материалов и конструкций.\n* Сохраняйте ссылки на проекты и обменивайтесь ими.',
      link: {
        path: '/projects'
      }
    },
    {
      ...
      text: '* Оценивайте стоимость проектирования и строительства деревянного дома или бани.\n* Меняйте параметры проекта под свои нужды и выбирайте итоговый вариант.\n* Определяйте соотвествующее именно вашей ситуации решение.\n* Сохраняйте ссылки на различные варианты расчетов.',
      link: {
        path: '/costs'
      }
    },
